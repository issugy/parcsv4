...
public class Main {
    ...
    public static void main(String[] args) {
        String jarPath = "PerfectNumberCounter.jar";
        ...
        System.out.println("Number of Perfect numbers in range [1, " + range + "] = " + totalCount);
    ...
    private static long getTotalCount(AMInfo info, long range, int numberOfWorkers) {
        ...
        for (int index = 0; index < numberOfWorkers; ++index) {
            ...
            point.execute(PerfectNumberCounter.class.getCanonicalName());
